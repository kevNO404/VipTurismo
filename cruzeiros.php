...
?>
		...
		<!-- Main -->
			<section id="main" class="wrapper style1">
				<header class="major">
					<h2>Cruzeiros</h2>
					<p>Viagens fascinantes nos melhores navios com os melhores preços, tanto nacionais como internacionais.</p>
				</header>
						
				<div class="container">
						<div class="row">
						<?php          
           					$sqlconsulta = "SELECT * from pacote where categoriaPac='Cruzeiro'";
